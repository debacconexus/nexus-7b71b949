...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Probationer Coordination Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Probationer";
process.env.TABLE_NAME = process.env.TABLE_NAME || "probationer_records";
'use strict';
